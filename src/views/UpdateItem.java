...
public class UpdateItem extends JFrame
{
    ...
    public UpdateItem()
    {
		...
		Item i = item.returnItem(Item.idAction);
		
		
        tf_ano_publi = new TextField(); 
		tf_ano_publi.setText(Integer.toString(i.getAnoPublicacao()));
        tf_titulo_obra = new TextField(); 
		tf_titulo_obra.setText(i.getTituloObra());
        tf_autor = new TextField(); 
		tf_autor.setText(i.getAutor());
        tf_editora = new TextField(); 
		tf_editora.setText(i.getEditora());
		...
		jcb_tipo_item.setSelectedIndex(index);
        ...
        bt_update.setBounds(200, 200, 140, 25);
	...
	private void actions()
	{
		...
		ActionListener ac = new ActionListener(){
            public void actionPerformed(ActionEvent e){
                if("eventoUpdate".equals(e.getActionCommand())){
					...
					if(jcb_tipo_item.getSelectedItem().equals("-- selecione uma opção -- ")){
						...
						if(cadastra){
							...
							JOptionPane.showMessageDialog(null, "Editado com sucesso", "Sucess", JOptionPane.INFORMATION_MESSAGE);
        ...
        bt_update.setActionCommand("eventoUpdate");
        bt_update.addActionListener(ac);
